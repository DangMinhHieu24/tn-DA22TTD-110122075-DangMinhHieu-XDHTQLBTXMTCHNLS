...
class AdminVehicleWarrantyPage extends StatefulWidget {
  final String vehicleId;
  final String? licensePlate;

  const AdminVehicleWarrantyPage({
    super.key,
  ...
  @override
  State<AdminVehicleWarrantyPage> createState() => _AdminVehicleWarrantyPageState();
}

class _AdminVehicleWarrantyPageState extends State<AdminVehicleWarrantyPage> {
